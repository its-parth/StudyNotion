    ...
    w-full rounded-lg p-3' type="email" id='emailId' placeholder='Enter Email Address'/>
                ...
                <div className='flex gap-3'>
                    <div className='flex-1  flex flex-col gap-1'>
                        ...
                        <div className='relative flex items-center'>
                            <input required name='password' value={formData.password} onChange={changeHandler} className='bg-richblack-800
            w-full rounded-lg p-3' type={`${showCreatePass? "text" : "password"}`} id="password" placeholder='Enter Password'/>
                    ...
                    <div className='flex-1 flex flex-col gap-1'>
                        ...
                        <div className='relative flex items-center'>
                            <input required name='confirmPassword' value={formData.confirmPassword} onChange={changeHandler} className='bg-richblack-800
