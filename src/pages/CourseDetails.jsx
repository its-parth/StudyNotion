...
function CourseDetails() {
  ...
  const handleBuyCourse = () => {
    ...
    console.log("before set confirmation modal")
  ...
  return (
    <div className="w-full">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap justify-between gap-2">
                <div className="flex gap-2">
                  ...
                  <span>{formatDuration(response.data?.totalDuration)} total length</span>
                </div>
                <div>
                  <button
      ...
      <Footer />
      {
        console.log("confirmationModal value: ", confirmationModal)
      }
